...
class ReKepOGEnv:
    ...
    def _move_to_waypoint(self, target_pose_world, pos_threshold=0.02, rot_threshold=3.0, max_steps=10):
        ...
        while count < max_steps:
            ...
            current_eef_pose = self.robot.get_relative_eef_position()
            if isinstance(current_eef_pose, torch.Tensor):
                current_eef_pose = current_eef_pose.cpu().numpy()
            relative_position = target_pose_robot[:3, 3] - current_eef_pose
